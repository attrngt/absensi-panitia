...
export default function Home() {
  ...
  // Custom style untuk React Select agar selaras dengan tema
  ...
  return (
    // Background gradasi gelap marun seperti suasana panggung
    <main className="min-h-screen bg-gradient-to-br from-[#3b0918] via-[#21040b] to-[#120105] flex items-center justify-center p-4 md:p-6 font-sans">
      {/* Container utama dengan warna krem pita (ribbon) dan border emas */}
